...
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}">
            <img style="width:168px;height:51px"
...
<div class="loginModel">
    <div class="loginDiv">
      ...
      <!--1 <div class="loginSwitch" id="loginSwitch"></div>-->
...
<div class="shopImg">
    <img style="width:100%;height:200px" src="${pageContext.request.contextPath}/res/images/item/categoryPicture/${requestScope.product.product_category.category_image_src}">
</div>
<div class="context">
    ...
    <div class="context_info">
        ...
        <div class="context_info_main">
            <div class="context_info_main_ad">
                ...
                <span>全天猫实物商品通用</span>-->
               <!-- <a href="#">去刮券<img
                        src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/tmallItemContentB.png">
                </a>-->
            </div>
